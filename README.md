# vbwd-fe-admin-plugin-referral

> VBWD fe-admin referral-admin plugin (S92 Track B)

**Type:** Admin frontend plugin · **Host app:** `vbwd-fe-admin` · **Plugin:** `referral`
